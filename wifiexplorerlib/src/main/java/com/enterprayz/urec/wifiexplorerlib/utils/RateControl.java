...
public class RateControl {
    ...
    private final String CMD = "/system/bin/ping -A -q -n -w 3 -W 2 -c 15 ";
    ...
    public void adaptRate() {
        ...
        if ((response_time = getAvgResponseTime(indicator)) > 0) {
            rate = response_time; // Minimum 500ms
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (matcher.matches()) {
                    ...
                    int res = (int) Float.parseFloat(matcher.group(1));
                    Log.i(TAG, "ping result - " + res);
                    return res;
                }
            }
            reader.close();
